...
@testset "quantile" begin
	q(p) = quantile(sample([3, 9]), p)
	@test_throws ErrorException q(prevfloat(0.0))
	@test isapprox(3.0, q(0.0))
	@test isapprox(3.0, q(nextfloat(0.0)))
	@test isapprox(3.0, q(0.25))
	@test isapprox(3.0, q(prevfloat(0.5, 3)))
	@test isapprox(6.0, q(0.5))
	@test isapprox(9.0, q(nextfloat(0.5, 3)))
	@test isapprox(9.0, q(0.75))
	@test isapprox(9.0, q(prevfloat(1.0)))
	@test isapprox(9.0, q(1.0))
	@test_throws ErrorException q(nextfloat(1.0))
	q(p) = quantile(sample([3, 5, 9]), p)
	@test_throws ErrorException q(prevfloat(0.0))
	@test isapprox(3.0, q(0.0))
	@test isapprox(3.0, q(nextfloat(0.0)))
	@test isapprox(3.0, q(prevfloat(1/3, 4)))
	@test isapprox(4.0, q(prevfloat(1/3, 1)))
	@test isapprox(4.0, q(1/3))
	@test isapprox(4.0, q(nextfloat(1/3, 1)))
	@test isapprox(5.0, q(nextfloat(1/3, 4)))
	@test isapprox(5.0, q(0.5))
	@test isapprox(5.0, q(prevfloat(2/3, 4)))
	@test isapprox(7.0, q(prevfloat(2/3, 1)))
	@test isapprox(7.0, q(2/3))
	@test isapprox(7.0, q(nextfloat(2/3, 1)))
	@test isapprox(9.0, q(nextfloat(2/3, 4)))
	@test isapprox(9.0, q(prevfloat(1.0)))
	@test isapprox(9.0, q(1.0))
	@test_throws ErrorException q(nextfloat(1.0))
end
